# Remove `packages/minerva/src/storage/db.ts`

## Goal

Remove all production usages of the legacy `packages/minerva/src/storage/db.ts` module.
...
Production imports from `packages/minerva/src/storage/db.ts` are concentrated in 22 source files:

- `packages/minerva/src/account/repo.ts`
- `packages/minerva/src/cli/cmd/db.ts`
- `packages/minerva/src/cli/cmd/import.ts`
- `packages/minerva/src/cli/cmd/stats.ts`
- `packages/minerva/src/control-plane/workspace.ts`
- `packages/minerva/src/index.ts`
- `packages/minerva/src/node.ts`
- `packages/minerva/src/permission/index.ts`
- `packages/minerva/src/project/project.ts`
- `packages/minerva/src/server/projectors.ts`
- `packages/minerva/src/server/routes/instance/httpapi/handlers/sync.ts`
- `packages/minerva/src/server/shared/fence.ts`
- `packages/minerva/src/session/message-v2.ts`
- `packages/minerva/src/session/projectors.ts`
- `packages/minerva/src/session/prompt.ts`
- `packages/minerva/src/session/session.ts`
- `packages/minerva/src/session/todo.ts`
- `packages/minerva/src/share/share-next.ts`
- `packages/minerva/src/storage/db.ts`
- `packages/minerva/src/sync/index.ts`
- `packages/minerva/src/worktree/index.ts`
...
Status: Completed. Startup, the public node export, and database CLI tooling no longer import the legacy opencode database wrapper; `packages/minerva/src/storage/db.ts` has been deleted.
...
All migration groups are complete or superseded. `packages/minerva/src/storage/db.ts` has been deleted.
...
- Existing schema ownership remains in `packages/core/src/**/*.sql.ts`; do not move table definitions back into `packages/minerva`.

## Verification Commands

- `rg "@/storage/db|./storage/db|Database\.(use|transaction|effect|Client|getPath)|\bTxOrDb\b|\bTransaction\b" packages/minerva/src`
- `bun typecheck` from `packages/minerva`
- Relevant package tests from `packages/minerva`, not the repo root
