...
declare const MINERVA_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof MINERVA_LIBC === "undefined" ? undefined : MINERVA_LIBC
...
export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.MINERVA_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.MINERVA_EXPERIMENTAL_FILEWATCHER) {
