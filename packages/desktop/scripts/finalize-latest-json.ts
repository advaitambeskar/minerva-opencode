...
const releaseId = process.env.MINERVA_RELEASE
if (!releaseId) throw new Error("MINERVA_RELEASE is required")

const version = process.env.MINERVA_VERSION
if (!version) throw new Error("MINERVA_VERSION is required")
...
const macxTarGz = "minerva-desktop-mac-x64.app.tar.gz"
const macaTarGz = "minerva-desktop-mac-arm64.app.tar.gz"
