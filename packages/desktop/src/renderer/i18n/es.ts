export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Minerva",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Minerva. ¿Quieres instalarla y reiniciar?",
