export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Minerva",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Minerva er lastet ned. Vil du installere den og starte på nytt?",
