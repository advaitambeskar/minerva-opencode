export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Minerva",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Minerva a été téléchargée. Voulez-vous l'installer et redémarrer ?",
