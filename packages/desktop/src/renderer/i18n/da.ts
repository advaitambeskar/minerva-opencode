export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Minerva",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Minerva er blevet downloadet. Vil du installere den og genstarte?",
