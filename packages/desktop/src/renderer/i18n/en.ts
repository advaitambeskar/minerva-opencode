export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Minerva",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Minerva has been downloaded, would you like to install it and relaunch?",
