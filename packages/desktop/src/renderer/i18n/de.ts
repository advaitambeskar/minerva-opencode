export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Minerva",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Minerva wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
