...
import type { UpdaterState } from "@minerva-ai/app/updater"
    ...
    integrations: (integrations) => {
      return integrations.filter(
        (i) =>
          i.name !== "Breadcrumbs" &&
          !(
            import.meta.env.MINERVA_CHANNEL === "prod" &&
...
const emitDeepLinks = (urls: string[]) => {
  ...
  window.__MINERVA__ ??= {}
  const pending = window.__MINERVA__.deepLinks ?? []
  window.__MINERVA__.deepLinks = [...pending, ...urls]
