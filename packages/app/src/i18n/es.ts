export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurados en minerva.json",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (minerva.json)",
