export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurados em minerva.json",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (minerva.json)",
