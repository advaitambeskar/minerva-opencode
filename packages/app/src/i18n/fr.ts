export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurés dans minerva.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (minerva.json) pour les noms de fournisseur/modèle",
