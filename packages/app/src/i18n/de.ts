...
export const dict = {
  ...
  "dialog.plugins.empty": "In minerva.json konfigurierte Plugins",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (minerva.json) auf Anbieter-/Modellnamen",
