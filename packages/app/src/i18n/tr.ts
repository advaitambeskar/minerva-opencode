...
export const dict = {
  ...
  "dialog.plugins.empty": "Eklentiler minerva.json içinde yapılandırılır",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (minerva.json) sağlayıcı/model adlarını kontrol edin",
