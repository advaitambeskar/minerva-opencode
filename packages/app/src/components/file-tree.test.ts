...
beforeAll(async () => {
  ...
  mock.module("@minerva-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@minerva-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@minerva-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@minerva-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
