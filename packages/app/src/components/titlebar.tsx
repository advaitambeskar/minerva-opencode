...
import { Tooltip, TooltipKeybind } from "@minerva-ai/ui/tooltip"
import { useTheme } from "@minerva-ai/ui/theme/context"
...
function ChannelIndicator() {
  return (
    <>
      {["beta", "dev"].includes(import.meta.env.VITE_MINERVA_CHANNEL) && (
        <div class="bg-icon-interactive-base text-[#FFF] font-medium px-2 rounded-sm uppercase font-mono">
          {import.meta.env.VITE_MINERVA_CHANNEL.toUpperCase()}
        </div>
      )}
    </>
  )
