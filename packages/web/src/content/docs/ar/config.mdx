...
2. **الإعدادات العامة** (`~/.config/opencode/minerva.json`) - تفضيلات المستخدم
3. **إعدادات مخصصة** (`MINERVA_CONFIG` env var) - تجاوزات مخصصة
4. **إعدادات المشروع** (`minerva.json` داخل المشروع) - إعدادات خاصة بالمشروع
5. **أدلة `.opencode`** - الوكلاء، الأوامر، الإضافات
6. **إعدادات ضمنية** (`MINERVA_CONFIG_CONTENT` env var) - تجاوزات وقت التشغيل
...
ضع إعدادات OpenCode العامة في `~/.config/opencode/minerva.json`. استخدم الإعدادات العامة للتفضيلات على مستوى المستخدم مثل السمات، والمزوّدين، أو اختصارات المفاتيح.
...
أضف `minerva.json` في جذر مشروعك. تمتلك إعدادات المشروع أعلى أولوية بين ملفات الإعدادات القياسية، إذ تتجاوز الإعدادات العامة والبعيدة معًا.
...
حدّد مسار ملف إعدادات مخصصًا باستخدام متغير البيئة `MINERVA_CONFIG`.
...
حدّد دليل إعدادات مخصصًا باستخدام متغير البيئة `MINERVA_CONFIG_DIR`.
...
يحتوي ملف الإعدادات على مخطط مُعرَّف في [**`opencode.ai/config.json`**](https://minerva.dev/config.json).
