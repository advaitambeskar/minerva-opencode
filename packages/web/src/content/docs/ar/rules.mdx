...
يمكنك تحديد ملفات تعليمات مخصصة في `minerva.json` أو في الملف العام `~/.config/opencode/minerva.json`. يتيح ذلك لك ولفريقك إعادة استخدام القواعد الموجودة بدلًا من تكرارها داخل AGENTS.md.
...
### استخدام minerva.json

النهج الموصى به هو استخدام الحقل `instructions` في `minerva.json`:
...
:::tip
بالنسبة للمستودعات متعددة الحزم (monorepos) أو المشاريع ذات المعايير المشتركة، فإن استخدام `minerva.json` مع أنماط glob (مثل `packages/*/AGENTS.md`) أسهل للصيانة من التعليمات اليدوية.
:::
