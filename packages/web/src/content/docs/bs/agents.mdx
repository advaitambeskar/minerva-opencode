...
Konfigurirajte agente u svom konfiguracijskom fajlu `minerva.json`:
...
:::tip
Imate li agenta kojeg biste željeli podijeliti? [Pošalji PR](https://github.com/advaitambeskar/minerva-opencode).
:::
