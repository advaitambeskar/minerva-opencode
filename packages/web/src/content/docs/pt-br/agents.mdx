...
Configure os agentes em seu arquivo de configuração `minerva.json`:
...
:::tip
Você tem um agente que gostaria de compartilhar? [Envie um PR](https://github.com/advaitambeskar/minerva-opencode).
:::
