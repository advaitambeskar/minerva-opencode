...
Isso é separado do `minerva.json`, que configura o comportamento do servidor/runtime.
...
Use `MINERVA_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
