...
Konfigurieren Sie Agenten in Ihrer `minerva.json`-Konfigurationsdatei:
...
```json title="minerva.json" {3-6,9-12}
{
  "$schema": "https://minerva.dev/config.json",
  "tools": {
    "write": true,
...
```json title="minerva.json" {3-5,8-10}
{
  "$schema": "https://minerva.dev/config.json",
  "permission": {
    "edit": "deny"
...
:::tip
Haben Sie einen Agenten, den Sie gerne teilen möchten? [Reichen Sie einen PR ein](https://github.com/advaitambeskar/minerva-opencode).
:::
