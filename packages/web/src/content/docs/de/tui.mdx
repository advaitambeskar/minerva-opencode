...
Dies ist getrennt von `minerva.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `MINERVA_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
