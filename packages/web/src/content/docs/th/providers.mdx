...
2. **กำหนดค่าการตรวจสอบสิทธิ์** โดยใช้วิธีใดวิธีหนึ่งต่อไปนี้:
   ...
   สำหรับการกำหนดค่าเฉพาะโครงการหรือแบบถาวร ให้ใช้ `minerva.json`:
...
`minerva.json` ไฟล์. ขอแนะนำให้ปิดใช้งานการแชร์เซสชันด้วย
...
4. สร้างหรืออัปเดตไฟล์ `minerva.json` ของคุณในไดเร็กทอรีโครงการของคุณ:
...
4. สร้างหรืออัปเดตไฟล์ `minerva.json` ในไดเรกทอรีโครงการของคุณ:
