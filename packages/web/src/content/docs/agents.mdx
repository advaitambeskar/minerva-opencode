...
Configure agents in your `minerva.json` config file:
...
:::tip
Do you have an agent you'd like to share? [Submit a PR](https://github.com/advaitambeskar/minerva-opencode).
:::
