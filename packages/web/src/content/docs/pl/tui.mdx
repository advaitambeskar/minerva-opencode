...
Jest to oddzielny plik od `minerva.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `MINERVA_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
