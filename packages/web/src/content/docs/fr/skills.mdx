...
Contrôlez les compétences auxquelles les agents peuvent accéder à l'aide d'autorisations basées sur des modèles dans `minerva.json` :
...
**Pour les agents intégrés** (dans `minerva.json`) :
