...
Ceci est séparé de `minerva.json`, qui configure le comportement du serveur/d'exécution.
...
Utilisez `MINERVA_TUI_CONFIG` pour charger un chemin de configuration TUI personnalisé.
