...
Configurez les agents dans votre fichier de configuration `minerva.json` :
...
:::tip
Avez-vous un agent que vous aimeriez partager ? [Soumettez un PR](https://github.com/advaitambeskar/minerva-opencode).
:::
