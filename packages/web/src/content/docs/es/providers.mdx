...
2. **Configure la autenticación** utilizando uno de los siguientes métodos:
   ...
   Para una configuración persistente o específica del proyecto, utilice `minerva.json`:
...
Archivo `minerva.json`. También se recomienda desactivar el uso compartido de sesiones.
...
Personalizar a través de `minerva.json`:
...
4. Cree o actualice su archivo `minerva.json` en el directorio de su proyecto:
