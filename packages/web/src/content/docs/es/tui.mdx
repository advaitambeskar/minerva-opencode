...
Esto es independiente de `minerva.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `MINERVA_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
