...
Configure agentes en su archivo de configuración `minerva.json`:
...
:::tip
¿Tiene un agente que le gustaría compartir? [Enviar un PR](https://github.com/advaitambeskar/minerva-opencode).
:::
