...
You can pass a configuration object to customize behavior. The instance still picks up your `minerva.json`, but you can override or add configuration inline:
