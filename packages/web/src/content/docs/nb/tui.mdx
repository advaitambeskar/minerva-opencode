...
Dette er atskilt fra `minerva.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `MINERVA_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
