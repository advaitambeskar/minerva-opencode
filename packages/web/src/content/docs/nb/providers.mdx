...
2. **Konfigurer autentisering** ved å bruke en av følgende metoder:
   ...
   For prosjektspesifikk eller vedvarende konfigurasjon, bruk `minerva.json`:
...
`minerva.json` fil. Det anbefales også å deaktivere øktdeling.
...
4. Opprett eller oppdater `minerva.json`-filen i prosjektkatalogen:
