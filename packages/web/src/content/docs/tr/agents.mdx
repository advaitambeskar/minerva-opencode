...
Agent'ları `minerva.json` yapılandırma dosyanızda yapılandırın:
...
:::tip
Paylaşmak istediğiniz bir agent'ınız var mı? [Submit a PR](https://github.com/advaitambeskar/minerva-opencode).
:::
