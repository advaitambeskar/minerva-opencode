...
Dette er adskilt fra `minerva.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `MINERVA_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
