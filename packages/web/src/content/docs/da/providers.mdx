...
2. **Konfigurer godkendelse** ved at bruge en af følgende metoder:
   ...
   For projektspecifik eller vedvarende konfiguration, brug `minerva.json`:
...
`minerva.json` fil. Det anbefales også at deaktivere sessionsdeling.
...
4. Opret eller opdater `minerva.json`-filen i projektkataloget:
