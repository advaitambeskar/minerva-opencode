...
2. **Configura l'autenticazione** usando uno dei seguenti metodi:
   ...
   ***
   ...
   Per configurazione specifica del progetto o persistente, usa `minerva.json`:
...
file `minerva.json`. Si raccomanda anche di disabilitare la condivisione sessioni.
...
Personalizza tramite `minerva.json`:
...
4. Crea o aggiorna il tuo file `minerva.json` nella directory del progetto:
