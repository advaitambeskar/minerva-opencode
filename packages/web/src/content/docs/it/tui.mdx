...
Questo è separato da `minerva.json`, che configura il comportamento di server/runtime.
...
Usa `MINERVA_TUI_CONFIG` per caricare un path di configurazione TUI personalizzato.
