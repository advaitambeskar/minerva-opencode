  ...
  Effect.gen(function* () {
    ...
    yield* Effect.addFinalizer(() =>
      Effect.sync(() => {
        ...
        restoreEnv("MINERVA_SERVER_PASSWORD", original.envPassword)
        restoreEnv("MINERVA_SERVER_USERNAME", original.envUsername)
      }),
    )
  }),
)
      ...
      Layer.provide(
        ConfigProvider.layer(
          ConfigProvider.fromUnknown({
            MINERVA_SERVER_PASSWORD: input?.password,
            MINERVA_SERVER_USERNAME: input?.username,
          }),
        ),
      ),
    ),
