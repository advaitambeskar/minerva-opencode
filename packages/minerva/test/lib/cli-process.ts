...
//   - MINERVA_CONFIG_CONTENT      : provider config inline, no files to find
//   - MINERVA_TEST_HOME           : pins os.homedir() → tmpdir
//   - MINERVA_DISABLE_PROJECT_CONFIG : skip walking up for minerva.json
//   - MINERVA_PURE                : skip external plugin discovery + install
//   - MINERVA_DISABLE_AUTOUPDATE / AUTOCOMPACT / MODELS_FETCH : no background work
...
function isolatedEnv(home: string, configJson: string): Record<string, string> {
  return {
    MINERVA_TEST_HOME: home,
    HOME: home,
    XDG_CONFIG_HOME: path.join(home, ".config"),
    XDG_DATA_HOME: path.join(home, ".local/share"),
    XDG_STATE_HOME: path.join(home, ".local/state"),
    XDG_CACHE_HOME: path.join(home, ".cache"),
    MINERVA_CONFIG_CONTENT: configJson,
    MINERVA_DISABLE_PROJECT_CONFIG: "1",
    MINERVA_PURE: "1",
    MINERVA_DISABLE_AUTOUPDATE: "1",
    MINERVA_DISABLE_AUTOCOMPACT: "1",
    MINERVA_DISABLE_MODELS_FETCH: "1",
    MINERVA_AUTH_CONTENT: "{}",
  }
}
