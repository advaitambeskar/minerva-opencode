...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders MINERVA_CALLER", () => {
    process.env["MINERVA_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode MINERVA_CALLER", () => {
    process.env["MINERVA_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown MINERVA_CALLER", () => {
    process.env["MINERVA_CALLER"] = "unknown"
