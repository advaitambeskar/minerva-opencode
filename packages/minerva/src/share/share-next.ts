...
import type * as SDK from "@minerva-ai/sdk/v2"
...
import { SessionShareTable } from "@minerva-ai/core/share/sql"
...
const disabled = process.env["MINERVA_DISABLE_SHARE"] === "true" || process.env["MINERVA_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@minerva/ShareNext") {}
