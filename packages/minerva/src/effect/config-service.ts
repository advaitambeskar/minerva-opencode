 ...
 *   "@minerva/ServerAuthConfig",
 *   {
 *     password: Config.string("MINERVA_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("MINERVA_SERVER_USERNAME").pipe(Config.withDefault("opencode")),
 *   },
 * ) {}
 *
