...
import { path } from "@minerva-ai/core/effect/layer-node-platform"
...
import type { ProjectV2 } from "@minerva-ai/core/project"
...
export class Service extends Context.Service<Service, Interface>()("@minerva/Worktree") {}
