...
>()("@minerva/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@minerva/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.MINERVA_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.MINERVA_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-minerva-directory"] || process.cwd()
}
