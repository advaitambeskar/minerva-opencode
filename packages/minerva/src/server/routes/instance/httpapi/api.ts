...
export const RootHttpApi = HttpApi.make("minerva-root")
...
export const InstanceHttpApi = HttpApi.make("minerva-instance")
...
export const OpenCodeHttpApi = HttpApi.make("minerva")
