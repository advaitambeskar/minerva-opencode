...
import { AccountStateTable, AccountTable } from "@minerva-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@minerva/AccountRepo") {}
