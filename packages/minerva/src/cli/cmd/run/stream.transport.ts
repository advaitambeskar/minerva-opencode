...
import type { Event, GlobalEvent, OpencodeClient } from "@minerva-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@minerva/RunStreamTransport") {}
