...
import type { AssistantMessage as OpenCodeAssistantMessage, Message } from "@minerva-ai/sdk/v2"
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@minerva/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@minerva/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@minerva/ACPUsage") {}
