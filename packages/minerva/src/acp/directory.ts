...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@minerva/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@minerva/ACPDirectory") {}
