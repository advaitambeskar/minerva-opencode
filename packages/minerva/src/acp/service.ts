...
import type { Message, OpencodeClient, SessionMessageResponse } from "@minerva-ai/sdk/v2"
...
export class Service extends Context.Service<Service, Interface>()("@minerva/ACP/Service") {}
