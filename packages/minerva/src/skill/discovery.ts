...
import { httpClient, path } from "@minerva-ai/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@minerva/SkillDiscovery") {}
