...
import { ProjectDirectoryTable, ProjectTable } from "@minerva-ai/core/project/sql"
...
import { which } from "@minerva-ai/core/util/which"
...
import { ProjectCopy } from "@minerva-ai/core/project/copy"
import { CrossSpawnSpawner } from "@minerva-ai/core/cross-spawn-spawner"
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@minerva-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@minerva/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.MINERVA_FAKE_VCS)
