...
import { PermissionV1 } from "@minerva-ai/core/v1/permission"
import { Slug } from "@minerva-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@minerva-ai/llm"
import { InstallationVersion } from "@minerva-ai/core/installation/version"
...
import { PartTable, SessionTable } from "@minerva-ai/core/session/sql"
...
import { WorkspaceV2 } from "@minerva-ai/core/workspace"
...
import { NonNegativeInt, optionalOmitUndefined } from "@minerva-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".agent", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@minerva/Session") {}
