import type { JsonSchema, LLMRequest, ProviderMetadata } from "@minerva-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@minerva-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @minerva-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
