...
import { llmClient } from "@minerva-ai/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@minerva-ai/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@minerva-ai/llm/route"
import type { LLMClientService } from "@minerva-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@minerva/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @minerva-ai/llm. It
