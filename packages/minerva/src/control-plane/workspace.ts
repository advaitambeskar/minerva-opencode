...
import { EventSequenceTable, EventTable } from "@minerva-ai/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@minerva/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        MINERVA_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        MINERVA_WORKSPACE_ID: config.id,
        MINERVA_EXPERIMENTAL_WORKSPACES: "true",
