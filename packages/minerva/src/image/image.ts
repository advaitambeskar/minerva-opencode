...
export class Service extends Context.Service<Service, Interface>()("@minerva/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __MINERVA_PHOTON_WASM_PATH?: string }).__MINERVA_PHOTON_WASM_PATH =
