...
import { Hash } from "@minerva-ai/core/util/hash"
...
import { optionalOmitUndefined } from "@minerva-ai/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@minerva-ai/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
    ...
    "amazon-bedrock": Effect.fnUntraced(function* () {
      ...
      return {
        ...
        async getModel(sdk: any, modelID: string, options?: Record<string, any>, model?: Model) {
          ...
          // 1. options.region from minerva.json provider config
...
export class Service extends Context.Service<Service, Interface>()("@minerva/Provider") {}
