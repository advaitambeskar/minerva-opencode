...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@minerva-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@minerva/ToolRegistry") {}
