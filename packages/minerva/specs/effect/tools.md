...
Practical reference for the current tool-migration state in `packages/minerva`.
...
Tool tests should use the existing Effect helpers in `packages/minerva/test/lib/effect.ts`:
