 ...
 * It can be disabled at build time by setting OPENCODE_DISABLE_VOICE=true.
 */
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const disabled = process.env.OPENCODE_DISABLE_VOICE === "true" || process.env.OPENCODE_DISABLE_VOICE === "1"
