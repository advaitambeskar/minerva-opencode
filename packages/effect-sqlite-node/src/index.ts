...
export const TypeId: TypeId = "~@minerva-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@minerva-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@minerva-ai/effect-sqlite-node/NodeSqliteClient")
