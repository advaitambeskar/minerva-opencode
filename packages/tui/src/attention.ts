...
import defaultSoundPath from "@minerva-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@minerva-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@minerva-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@minerva-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@minerva-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@minerva-ai/ui/audio/yup-01.mp3" with { type: "file" }
