...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/minerva/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/minerva (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/minerva/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/minerva/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const MINERVA_DB|MINERVA_DB|MINERVA_DEV|Global\\.Path\\.data|data =" in packages/minerva/src (115 matches)',
  },
] as const
