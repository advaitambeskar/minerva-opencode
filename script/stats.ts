...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/advaitambeskar/minerva-opencode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for advaitambeskar/minerva-opencode...\n")
...
console.log("Fetching npm all-time downloads for minerva-ai...\n")
const npmDownloads = await fetchNpmDownloads("minerva-ai")
